...
class menu:
    ...
    def __init__(self):
        self.root=Tk()
        self.root.title('Trinity Library')
        ...
        l1=Button(self.a,text='BOOK DATA',font='Papyrus 22 bold',fg='white',bg='Black',width=19,padx=10,borderwidth=0,command=self.book).place(x=400,y=400)
        l2=Button(self.a,text='STUDENT DATA',font='Papyrus 22 bold',fg='white',bg='Black',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=400)
        self.root.mainloop()
